...
export default function TextbookExchangeScreen({ navigation }) {
    ...
    <View style={[{ flex: 1, backgroundColor: currentTheme.background }]}>
      ...
      <View style={[{ backgroundColor: currentTheme.background, paddingTop: 56, paddingBottom: 24, paddingHorizontal: 24, borderBottomWidth: 1, borderBottomColor: currentTheme.border }]}>
        ...
        <View style={[{ alignItems: 'center' }]}>
          <Text style={[{ fontSize: 30, fontWeight: 'bold', color: currentTheme.primary, textAlign: 'center', marginBottom: 8 }]}>📚 Textbook Exchange</Text>
          <Text style={[{ color: currentTheme.textSecondary, textAlign: 'center' }]}>
            Buy, sell, and trade textbooks with classmates
          </Text>
        </View>
      </View>
      ...
      <ScrollView style={[{ flex: 1 }]} contentContainerStyle={{ padding: 20 }}>
        <View style={[{ alignItems: 'center', paddingVertical: 40 }]}>
          ...
          <Text style={[{ color: currentTheme.textSecondary, textAlign: 'center', fontSize: 16, marginBottom: 24, lineHeight: 22 }]}>
            This feature is coming soon! You'll be able to buy, sell, and trade textbooks with your classmates.
          </Text>
          ...
          <View style={[{ backgroundColor: currentTheme.surface, borderRadius: 16, padding: 20, marginBottom: 20, borderWidth: 1, borderColor: currentTheme.border }]}>
            ...
            <Text style={[{ color: currentTheme.text, marginBottom: 8 }]}>• List your textbooks for sale</Text>
            <Text style={[{ color: currentTheme.text, marginBottom: 8 }]}>• Browse available textbooks</Text>
            <Text style={[{ color: currentTheme.text, marginBottom: 8 }]}>• Direct messaging with sellers</Text>
            <Text style={[{ color: currentTheme.text, marginBottom: 8 }]}>• Price comparison tools</Text>
            <Text style={[{ color: currentTheme.text }]}>• Trade matching system</Text>
          </View>
